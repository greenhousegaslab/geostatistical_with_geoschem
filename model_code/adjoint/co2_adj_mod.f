...
!
      ...
      USE LOGICAL_ADJ_MOD, ONLY : LADJ, LADJ_EMS,LFDTEST
...
!$OMP+PRIVATE( E_CO2_ADJ             )
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2ff) + E_CO2_ADJ 
            ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2ocn) + E_CO2_ADJ 
            ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2bal) + E_CO2_ADJ 
            ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2bb) + E_CO2_ADJ 
            ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2bf) + E_CO2_ADJ 
            ENDIF
     ...
     &           EMS_SF_ADJ(I,J,M,IDADJ_ECO2nte) + E_CO2_ADJ 
            ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2shp) + E_CO2_ADJ 
            ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2pln) + E_CO2_ADJ 
            ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2che) + E_CO2_ADJ 
            ENDIF
           ENDDO
         ENDIF
     ...
     &            EMS_SF_ADJ(I,J,M,IDADJ_ECO2sur) + E_CO2_ADJ 
            ENDIF
