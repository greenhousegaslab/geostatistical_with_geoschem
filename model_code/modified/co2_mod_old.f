...
!
      ...
      !USE ADJ_ARRAYS_MOD,  ONLY : GET_SCALE_GROUP !zc
...
!      WRITE( SDOY, '(i3.3)' ) DOY
      ...
      FILENAME = TRIM( '~/work/smiller/data/OCO2_MIP/flux_est/' ) //
     &           'CO2.daily.' //
     &           GET_NAME_EXT_2D() // '.'              //
     &           GET_RES_EXT()     // '.'              // SDOY
...
! zc wrote this function in Nov, 2018; Johns Hopkins University
! NOTES
...
#     include "CMN_SIZE" ! Size stuff
      ...
      ! Function variable
      INTEGER       :: CURRENT_GROUP !kcw, just for now (8/2015)
...
!Test doing three-month scaling factors (kcw, 8/2015)
         IF (GROUP_SAVE == (CURRENT_GROUP + 1)) THEN
