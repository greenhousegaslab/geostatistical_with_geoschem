...
!!! (mps, 10/23/2015)
      ...
      ! Read 1-hr time-averaged data
      DATE = GET_FIRST_A1_TIME()
      CALL MERRA2_READ_A1( DATE(1), DATE(2) )

      ! Read 3-hr time averaged data
      DATE = GET_FIRST_A3_TIME()
      CALL MERRA2_READ_A3( DATE(1), DATE(2) )

      ! Read 3-hr time averaged data
      DATE = GET_FIRST_I3_TIME()
      CALL MERRA2_READ_I3_1( DATE(1), DATE(2) )
...
!!! (mps, 10/23/2015)
      ...
      IF ( ITS_TIME_ FOR_I3() ) THEN
         DATE = GET_I3_TIME()
         CALL MERRA2_READ_I3_2( DATE(1), DATE(2) )
...
!         CALL CHECK_STT_NESTED( 'after chemistry' )
!         ! (mps, 10/23/2015)
...
!            CALL CHECK_STT_NESTED( 'End of Dynamic Loop' )
!! (lzh,11/15/2014)
...
#if defined ( GEOS_4 )  || defined ( GEOS_5 ) || defined( GEOS_FP ) || defined( MERRA2 )
...
#elif defined( MERRA2     )
      WRITE( 6, '(a)' ) 'Using MERRA2/fvDAS met fields'
#elif defined( GCAP       )
