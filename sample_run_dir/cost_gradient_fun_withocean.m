...
function [ f,g ] = cost_gradient_fun( X, A, B, Einv, Dinv, Dinv1, CD, CD1, CE, shat, landmap, year, geosdir, fluxpath);
...
%-----------------------------------------------------% 
	...
	% Note from Scot: originally, I used the transpose of CD and CE in this section.
	% I'm not 100% sure why I did that.
	% Instead, I actually think I get more accurate results if I don't use the transpose.
	% (though the results with the transpose aren't horrible)
